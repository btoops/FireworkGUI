...
public class Canvas extends JFrame{
	...
	private String[] c = {"black" , "blue", "red" , "orange" , "cyan" , "magenta" , "green" , "yellow"};
	...
	public Canvas() {
		...
		colors.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				System.out.println((String) colors.getSelectedItem());
	...
	public void paint(Graphics g) {
		...
		if(timer2.isRunning()) {
			...
			//"blue" , "black", "red" , "orange" , "cyan" , "magenta" , "green" , "yellow"};
